  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6">View your completed tasks and manage reviews</p>
        
        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gradient-to-r from-[#0038FF] to-[#0021A5] text-white rounded-2xl p-6 shadow-lg">
          ...
          <div className="bg-gradient-to-r from-[#FF5A1F] to-[#E63A0B] text-white rounded-2xl p-6 shadow-lg">
            <div className="flex items-center justify-between">
              <div>
