      ...
      <div className="bg-white rounded-2xl w-full max-w-3xl p-6 mx-4 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center">
            <button
              onClick={toggleAudio}
              className={`p-2 rounded-full mr-2 ${isAudioEnabled ? 'text-[#0038FF] hover:bg-blue-50' : 'text-gray-400 hover:bg-gray-100'} transition-colors`}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 p-4 rounded-xl shadow-sm border border-blue-100">
                <div className="flex items-center mb-2">
                  ...
                  <h3 className="font-semibold text-sm text-[#0F2557]">Voice Assistant</h3>
                </div>
                <p className="text-gray-600 text-sm">
