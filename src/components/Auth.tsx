...
const Auth: React.FC<AuthProps> = ({ initialMode = 'signin', onClose }) => {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    const isAdminAccount = trimmedEmail === 'kaushalthota1@gmail.com';
    ...
    if (isSignUp) {
      ...
      // For sign in, validate email format
          ...
          {!onClose && (
            <div className="text-center mb-6">
              <div className="flex justify-center mb-4">
                <div className="w-12 h-12 bg-[#0F2557] rounded-lg flex items-center justify-center">
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                placeholder={email === 'kaushalthota1@gmail.com' ? 'Admin Email' : 'username@ufl.edu'}
                className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#0F2557] focus:border-[#0F2557] sm:text-sm"
              />
            </div>
          </div>
